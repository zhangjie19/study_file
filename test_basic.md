...
![image-20221029205457494](.\img\image-20221029205457494.png)
...
- 验收测试与系统测试非常相似，主要区别是测试人员不同，验收测试由用户执行
  ...
  - ![image-20221029212632749](.\img\image-20221029212632749.png)
...
4. 按不同的测试手段划分
   - ![image-20221029214144541](.\img\image-20221029214144541.png)
...
6. 其他测试
   ...
   - 冒烟测试（主干流程测试，开发做冒烟给报告到测试测试做系统测试）
     ...
     - ![](.\img\image-20221029221248310.png)
...
- ![image-20221029224126751](.\img\image-20221029224126751.png)

- ![image-20221029224156419](.\img\image-20221029224156419.png)
...
- 软件生命周期各阶段
   ...
   2. 测试计划阶段
      ...
      - ![ ](.\img\image-20221101194634782.png)
      - ![image-20221101194858727](.\img\image-20221101194858727.png)
   3. 测试设计阶段
   ...
   4. 测试执行阶段
      ...
      - ![image-20221101213930884](.\img\image-20221101213930884.png)
   5. 测试评估阶段
      - 出测试报告，对整个测试的过程和版本质量做一个详细的评估，确认是否可以上线
      - ![image-20221101214218212](.\img\image-20221101214218212.png)
...
- 软件测试需求分析的一般步骤
  ...
  - ![image-20221101224930279](.\img\image-20221101224930279.png)
...
3. 测试计划的核心内容
   ...
   - 为测试的设计、试试和评估安排时间进度
   - 为确定的测试活动分配资源
   - 测试目标--测到什么程度结束![image-20221102195734552](.\img\image-20221102195734552.png)
   - ![image-20221102195822386](.\img\image-20221102195822386.png)
   - 测试周期 --周期和进度
   - 资源配置  人力资源、测试环境、测试工具
...
- 因果图是一种适合于描述对于多种输入条件组合的测试方法，根据输入条件的组合、约束关系和输出条件的因果关系，分析输入条件的各种组合情况，从而设计测试用例的方法，它适合于检查程序输入条件设计的各种组合情况
  - 因果图分析步骤
    ...
    3. 根据因果图得出判定表
    4. 根据判定表设计测试用例
  - ![image-20221105163046266](.\img\image-20221105163046266.png)
  - ![image-20221105155918194](.\img\image-20221105155918194.png)
...
- 场景法的概念
  ...
  - ![image-20221105164010065](.\img\image-20221105164010065.png)

  - ![image-20221105164031687](.\img\image-20221105164031687.png)

  - ![image-20221105164216742](.\img\image-20221105164216742.png)
